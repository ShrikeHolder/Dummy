                    ...
                    <div class="col">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">Menikmati hangat dan kenyamanan dari roti yang baru dipanggang, dibuat dengan cinta dan perhatian.
                            Sesuai untuk sarapan yang nyaman atau camilan yang memuaskan, roti kami adalah tawaran untuk indra.
                    ...
                    <div class="col">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">Siapkan diri Anda untuk mengalami sensasi rasa pastry yang luar biasa dengan produk kami.
                            Dengan bahan-bahan berkualitas dan proses pembuatan yang teliti,
                            pastry kami menawarkan tekstur yang lembut dan rasa yang enak. Coba sekarang dan rasakan perbedaan!</p>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="card h-100">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">Perkenalkan diri Anda pada kelezatan cake yang tak terlupakan dengan produk kami.
                            Dengan bahan-bahan premium dan proses pembuatan yang teliti,
                            cake kami menawarkan tekstur yang lembut dan rasa yang enak. Coba sekarang dan rasakan perbedaan!</p>
                        </div>
                      </div>
                    </div>
                </div>
